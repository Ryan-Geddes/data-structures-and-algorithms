...
Without altering the html, write a function named generateSubmitButton that uses jQuery to 
create a submit button with the text "submit" and append it to the DOM.
------------------------------------------------------------------------------------------------ */
...
const isCapitalized = (str) => {
    let checker = /\b[A-Z][a-z]*\b/g;
    let checkerArr = str.match(checker);
         if (checkerArr){
...
Write a function named citiesAtoJ that takes in an array of 
city names and uses a regular expression 
pattern to return a new array containing any 
cities that begin with the letters A through J, inclusive.
------------------------------------------------------------------------------------------------ */
...
const citiesAtoJ = (arr) => {
    ...
    for (var i = 0; i < arr.length; i++){
        let city = arr[i];
        let checker = /^[A-J]/g;
        let checkerArr = city.match(checker);
        console.log(city);
        if (checkerArr){
