...
Write a function named sayHello, that sends the message
 'Hello from the back-end' when a user hits the `/hello` route.
...
function sayHello(request, response){
    let message = 'Hello from the back-end'
...
//   let vowels = arr.filter((word) => {
//       let checker = /[aeiou]/g;
//       let checkerArr = word.match(checker);
//       if (checkerArr){
//           console.log(word);
//           return word;
//       }
...
//FILTER EXPECTS TRUE AND FALSE VALS

const notInFirstArray = (forbiddenValues, arr) => {
  let uncursedArr = arr.filter((value) =>{
