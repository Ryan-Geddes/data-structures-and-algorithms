...
Write a function named alphabetizeBetter that takes in an array of strings 
...
Write a function named sortNumbersByLength that takes 
in an array of numbers and sorts those numbers by their length.
...
const sortNumbersByLength = (arr) => {
        return arr.sort((a,b) => {
            var stringA = a.toString().length;
            var stringB = b.toString().length;
          if (stringA < stringB) {
              return -1;
          }
          if (stringA > stringB) {
...
Person objects, each of which has firstName, lastName, and age properties, 
